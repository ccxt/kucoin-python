...
- `create_contract_order_request(self, symbol: Str, type: Str, side: Str, amount: Num, price: Num = None, params: dict = {})`
- `create_contract_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params: dict = {})`
- `create_contract_orders(self, orders: list[OrderRequest], params: dict = {})`
- `create_deposit_address(self, code: str, params: dict = {})`
- `create_market_buy_order_with_cost(self, symbol: str, cost: float, params: dict = {})`
- `create_market_order_with_cost(self, symbol: str, side: OrderSide, cost: float, params: dict = {})`
...
- `create_spot_orders(self, orders: list[OrderRequest], params: dict = {})`
- `create_uta_order_request(self, symbol: Str, type: Str, side: Str, amount: Num, price: Num = None, params: dict = {})`
- `create_uta_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params: dict = {})`
...
- `fetch_contract_balance(self, params: dict = {})`
- `fetch_contract_deposit_address(self, code: str, params: dict = {})`
- `fetch_contract_deposits(self, code: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_contract_markets(self, params: dict = {})`
- `fetch_contract_ohlcv(self, symbol: str, timeframe: str = '1m', since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_contract_order(self, id: Str, symbol: Str = None, params: dict = {})`
- `fetch_contract_orders_by_status(self, status: Str, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_contract_tickers(self, symbols: Strings = None, params: dict = {})`
- `fetch_contract_withdrawals(self, code: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
...
- `fetch_my_contract_trades(self, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_my_spot_trades(self, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_my_trades(self, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_my_uta_trades(self, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_ohlcv(self, symbol: str, timeframe: str = '1m', since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_open_interest_history(self, symbol: str, timeframe='5m', since: Int = None, limit: Int = None, params: dict = {})`
...
- `fetch_orders_by_status(self, status: Str, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
...
- `fetch_spot_ohlcv(self, symbol: str, timeframe: str = '1m', since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_spot_order(self, id: str, symbol: Str = None, params: dict = {})`
- `fetch_spot_orders_by_status(self, status: object, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
...
- `fetch_transaction_fee(self, code: str, params: dict = {})`
- `fetch_transfers(self, code: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_uta_balance(self, params: dict = {})`
- `fetch_uta_markets(self, params: dict = {})`
- `fetch_uta_order(self, id: Str, symbol: Str = None, params: dict = {})`
- `fetch_uta_orders_by_status(self, status: object, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_utaohlcv(self, symbol: str, timeframe: str = '1m', since: Int = None, limit: Int = None, params: dict = {})`
...
- `calculate_rate_limiter_cost(self, api: object, method: object, path: object, params: object, config: object = {})`
- `cancel_all_contract_orders(self, symbol: Str = None, params: dict = {})`
- `cancel_all_orders(self, symbol: Str = None, params: dict = {})`
- `cancel_all_spot_orders(self, symbol: Str = None, params: dict = {})`
- `cancel_all_uta_orders(self, symbol: Str = None, params: dict = {})`
- `cancel_contract_order(self, id: str, symbol: Str = None, params: dict = {})`
- `cancel_order(self, id: str, symbol: Str = None, params: dict = {})`
- `cancel_orders(self, ids: list[str], symbol: Str = None, params: dict = {})`
- `cancel_spot_order(self, id: str, symbol: Str = None, params: dict = {})`
- `cancel_uta_order(self, id: str, symbol: Str = None, params: dict = {})`
...
- `is_futures_method(self, methodName: str, params: dict)`
- `is_hf_or_mining(self, fromId: Str, toId: Str)`
- `is_uta_enabled(self, params: dict = {})`
- `market_order_amount_to_precision(self, symbol: Str, amount: object)`
- `nonce(self)`
...
- `set_contract_leverage(self, leverage: int, symbol: Str = None, params: dict = {})`
...
- `transfer_classic(self, code: str, amount: float, fromAccount: str, toAccount: str, params: dict = {})`
- `transfer_uta(self, code: str, amount: float, fromAccount: str, toAccount: str, params: dict = {})`
- `transfer(self, code: str, amount: float, fromAccount: str, toAccount: str, params: dict = {})`
- `type_to_trade_type(self, type: Str)`
...
- `describe(self)`
- `negotiate(self, privateChannel: object, isFuturesMethod: bool = False, params: dict = {})`
- `negotiate_helper(self, privateChannel: object, connectId: str, params: dict = {})`
- `subscribe(self, url: str, messageHash: str, subscriptionHash: str, params: dict = {}, subscription: dict = None)`
- `subscribe_public_uta(self, messageHash: str, channel: str, symbol: str, params: dict = {}, subscription: dict = None)`
- `subscribe_private_uta(self, messageHashes: list[str], subscribeHash: str, channel: str, symbol: Str = None, params: dict = {}, subscription: dict = None)`
- `get_uta_url(self)`
- `authenticate_uta(self)`
- `un_subscribe(self, url: object, messageHash: object, topic: object, subscriptionHash: object, params={}, subscription: dict = None)`
- `subscribe_multiple(self, url: str, messageHashes: list[str], topic: str, subscriptionHashes: list[str], params: dict = {}, subscription: dict = None)`
- `un_subscribe_multiple(self, url: str, messageHashes: list[str], topic: str, subscriptionHashes: list[str], params: dict = {}, subscription: dict = None)`
- `watch_ticker(self, symbol: str, params: dict = {})`
- `un_watch_ticker(self, symbol: str, params: dict = {})`
- `watch_tickers(self, symbols: Strings = None, params: dict = {})`
- `subscribe_public_multiple_uta(self, messageHashes: list[str], channel: str, symbols: list[object], params: dict = {}, subscription: dict = None)`
- `watch_uta_tickers(self, symbols: Strings = None, params: dict = {})`
- `watch_bids_asks(self, symbols: Strings = None, params: dict = {})`
- `watch_multi_helper(self, methodName: str, channelName: str, isFuturesChannel: bool, symbols: Strings = None, params: dict = {})`
...
- `get_cache_index(self, orderbook: object, cache: object)`
- `watch_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `get_orders_message_hash_suffix(self, topic: Str)`
- `watch_my_trades(self, symbol: Str = None, since: Int = None, limit: Int = None, params={})`
- `get_my_trades_message_hash_suffix(self, topic: object)`
- `watch_balance(self, params: dict = {})`
- `set_balance_cache(self, client: Client, type: str)`
- `load_balance_snapshot(self, client: Client, messageHash: str, type: str)`
- `watch_position(self, symbol: Str = None, params: dict = {})`
- `watch_positions(self, symbols: Strings = None, since: Int = None, limit: Int = None, params: dict = {})`
- `get_current_position(self, symbol: str)`
- `set_positions_cache(self, client: Client, uta: bool)`
- `load_positions_snapshot(self, client: Client, messageHash: str, uta: bool)`
- `set_position_cache(self, client: Client, symbol: str)`
- `load_position_snapshot(self, client: Client, messageHash: str, symbol: str)`
- `watch_funding_rate(self, symbol: str, params: dict = {})`
- `un_watch_funding_rate(self, symbol: str, params={})`
