...
- `create_contract_order_request(self, symbol: Str, type: Str, side: Str, amount: Num, price: Num = None, params={})`
- `create_contract_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params={})`
- `create_contract_orders(self, orders: list[OrderRequest], params={})`
...
- `create_spot_order_request(self, symbol: Str, type: Str, side: Str, amount: Num, price: Num = None, params={})`
- `create_spot_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params={})`
- `create_spot_orders(self, orders: list[OrderRequest], params={})`
- `create_uta_order_request(self, symbol: Str, type: Str, side: Str, amount: Num, price: Num = None, params={})`
- `create_uta_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params={})`
...
- `fetch_contract_balance(self, params={})`
- `fetch_contract_deposit_address(self, code: str, params={})`
- `fetch_contract_deposits(self, code: Str = None, since: Int = None, limit: Int = None, params={})`
- `fetch_contract_markets(self, params: object = {})`
- `fetch_contract_ohlcv(self, symbol: str, timeframe: str = '1m', since: Int = None, limit: Int = None, params={})`
- `fetch_contract_order(self, id: Str, symbol: Str = None, params={})`
- `fetch_contract_orders_by_status(self, status: object, symbol: Str = None, since: Int = None, limit: Int = None, params={})`
- `fetch_contract_tickers(self, symbols: Strings = None, params={})`
- `fetch_contract_withdrawals(self, code: Str = None, since: Int = None, limit: Int = None, params={})`
...
- `fetch_my_contract_trades(self, symbol: Str = None, since: Int = None, limit: Int = None, params={})`
- `fetch_my_spot_trades(self, symbol: Str = None, since: Int = None, limit: Int = None, params={})`
- `fetch_my_trades(self, symbol: Str = None, since: Int = None, limit: Int = None, params={})`
- `fetch_my_uta_trades(self, symbol: Str = None, since: Int = None, limit: Int = None, params={})`
...
- `fetch_spot_ohlcv(self, symbol: str, timeframe: str = '1m', since: Int = None, limit: Int = None, params={})`
- `fetch_spot_order(self, id: str, symbol: Str = None, params={})`
- `fetch_spot_orders_by_status(self, status: object, symbol: Str = None, since: Int = None, limit: Int = None, params={})`
...
- `fetch_uta_balance(self, params={})`
- `fetch_uta_markets(self, params={})`
- `fetch_uta_order(self, id: Str, symbol: Str = None, params={})`
- `fetch_uta_orders_by_status(self, status: object, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_utaohlcv(self, symbol: str, timeframe: str = '1m', since: Int = None, limit: Int = None, params={})`
...
- `calculate_rate_limiter_cost(self, api: object, method: object, path: object, params: object, config={})`
- `cancel_all_contract_orders(self, symbol: Str = None, params={})`
- `cancel_all_orders(self, symbol: Str = None, params={})`
- `cancel_all_spot_orders(self, symbol: Str = None, params={})`
- `cancel_all_uta_orders(self, symbol: Str = None, params={})`
- `cancel_contract_order(self, id: str, symbol: Str = None, params={})`
- `cancel_order(self, id: str, symbol: Str = None, params={})`
- `cancel_orders(self, ids: list[str], symbol: Str = None, params={})`
- `cancel_spot_order(self, id: str, symbol: Str = None, params={})`
- `cancel_uta_order(self, id: str, symbol: Str = None, params={})`
- `close_position(self, symbol: str, side: OrderSide = None, params={})`
- `describe(self)`
- `edit_order(self, id: str, symbol: str, type: OrderType, side: OrderSide, amount: Num = None, price: Num = None, params={})`
- `is_futures_method(self, methodName: object, params: object)`
- `is_hf_or_mining(self, fromId: Str, toId: Str)`
- `is_uta_enabled(self, params={})`
...
- `set_contract_leverage(self, leverage: int, symbol: Str = None, params={})`
- `set_leverage(self, leverage: int, symbol: Str = None, params={})`
- `set_margin_mode(self, marginMode: str, symbol: Str = None, params={})`
- `set_position_mode(self, hedged: bool, symbol: Str = None, params={})`
- `transfer_classic(self, code: str, amount: float, fromAccount: str, toAccount: str, params={})`
- `transfer_uta(self, code: str, amount: float, fromAccount: str, toAccount: str, params={})`
...
- `describe(self)`
- `negotiate(self, privateChannel: object, isFuturesMethod=False, params={})`
- `negotiate_helper(self, privateChannel: object, connectId: object, params={})`
- `subscribe(self, url: object, messageHash: object, subscriptionHash: object, params={}, subscription: dict | None = None)`
- `subscribe_public_uta(self, messageHash: object, channel: object, symbol: object, params={}, subscription: dict = None)`
- `subscribe_private_uta(self, messageHashes: object, subscribeHash: object, channel: object, symbol: Str = None, params={}, subscription: dict = None)`
- `get_uta_url(self)`
...
- `subscribe_multiple(self, url: object, messageHashes: object, topic: object, subscriptionHashes: object, params={}, subscription: dict = None)`
- `un_subscribe_multiple(self, url: object, messageHashes: object, topic: object, subscriptionHashes: object, params={}, subscription: dict = None)`
- `watch_ticker(self, symbol: str, params={})`
- `un_watch_ticker(self, symbol: str, params={})`
- `watch_tickers(self, symbols: Strings = None, params={})`
- `subscribe_public_multiple_uta(self, messageHashes: object, channel: object, symbols: object, params={}, subscription: dict | None = None)`
- `watch_uta_tickers(self, symbols: Strings = None, params={})`
- `watch_bids_asks(self, symbols: Strings = None, params={})`
- `watch_multi_helper(self, methodName: object, channelName: str, isFuturesChannel: bool, symbols: Strings = None, params={})`
...
- `get_orders_message_hash_suffix(self, topic: object)`
- `watch_my_trades(self, symbol: Str = None, since: Int = None, limit: Int = None, params={})`
- `get_my_trades_message_hash_suffix(self, topic: object)`
- `watch_balance(self, params={})`
- `set_balance_cache(self, client: Client, type: object)`
- `load_balance_snapshot(self, client: Client, messageHash: object, type: object)`
- `watch_position(self, symbol: Str = None, params={})`
- `watch_positions(self, symbols: Strings = None, since: Int = None, limit: Int = None, params={})`
- `get_current_position(self, symbol: object)`
- `set_positions_cache(self, client: Client, uta: object)`
- `load_positions_snapshot(self, client: Client, messageHash: object, uta: object)`
- `set_position_cache(self, client: Client, symbol: str)`
- `load_position_snapshot(self, client: Client, messageHash: object, symbol: object)`
