...
- `subscribe_public_uta(self, messageHash, channel, symbol, params={}, subscription=None)`
- `subscribe_private_uta(self, messageHashes, subscribeHash, channel, symbol=None, params={}, subscription=None)`
- `get_uta_url(self)`
